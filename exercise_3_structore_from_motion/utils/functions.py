...
def inliers_epipolar_constraint(p1: t_points, p2: t_points, F:t_homography, distance_threshold: float) -> np.array:
    ...
    Args:
        p1: A numpy array of shape [N, 2] representing the feature points in the source image
        p2: A numpy array of shape [N, 2] representing the corresponding matching feature points in the destination image
